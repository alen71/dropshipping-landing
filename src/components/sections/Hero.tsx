      ...
      <div id="hero" className="relative md:h-full flex items-center">
        ...
        <div className="flex flex-col px-6 sm:px-10 xl:px-20 pt-32 sm:pt-36 lg:pt-40 h-fit">
          ...
          <div className="mb-16 sm:mb-14 flex flex-col gap-2">
            ...
            >
              Jednokratno <span className="line-through">$1490</span> $490.
            </motion.b>
          ...
          <div className="grid grid-cols-1 lg:grid-cols-[20rem_auto] xl:grid-cols-[25rem_auto] items-center gap-x-6 xl:gap-x-10 2xl:gap-x-20 max-h-fit lg:max-h-[22.625rem] max-w-[90rem] gap-y-10">
            <div className="bg-main-purple relative rounded-2xl h-fit lg:h-full">
              ...
              <div
                ref={cartContainer}
                className="w-[60%] ml-auto overflow-hidden"
              >
                <motion.div
                  initial={{ x: '100%' }}
            ...
            <div className="grid grid-cols-[auto_1fr] gap-x-4 h-[14rem] sm:h-[25rem] lg:h-full w-full border-2 rounded-2xl px-4 sm:px-8 2xl:px-12 py-4 sm:py-9 color-white text-[0.625rem] sm:text-sm md:text-base relative">
