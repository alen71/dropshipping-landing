    ...
    <MainSection>
      <div className="max-w-[78.25rem] flex flex-col">
        ...
        <div className="grid grid-cols-[25rem_auto] items-center gap-x-20 max-h-[22.625rem]">
          ...
          <div className="flex flex-col justify-between h-full w-full border-2 rounded-2xl px-12 py-9 color-white text-xl relative">
            <svg
              width="77%"
              height="204"
              viewBox="0 0 575 204"
              ...
              className="absolute right-7 bottom-16"
            >
              <path
            ...
            <div className="grid grid-cols-[auto_1fr] items-center gap-x-4 ">
              <p className="font-light ">RSD 200K</p>
              <div className="h-1 w-full bg-white/50" />
            </div>

            <div className="grid grid-cols-[auto_1fr] items-center gap-x-4">
              <p className="font-light l">RSD 100K</p>
              <div className="h-1 w-full bg-white/50" />
            </div>

            <div className="grid grid-cols-[auto_1fr_auto] items-center gap-x-4">
              <p className="ml-8 font-light ">RSD 0</p>
